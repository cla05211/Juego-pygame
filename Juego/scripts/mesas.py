...
class Mesa(Objetos):
    ...
    def llenar_mesa(self, tiempo_juego:int,cliente,indice_mesa:int):
        tiempo_extra_mesa = 4000 * indice_mesa
        if (tiempo_juego - self.tiempo_vacia - tiempo_extra_mesa) > TIEMPO_LIMITE_MESA_VACIA and self.dinero == None:
