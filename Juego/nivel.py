                    ...
                    #Interacciones (tecla Z)        
                        ...
                        for mesa in lista_mesas:
                            ...
                            if mesa.pedido_tomado:
                                if True in colisiones_barra and comprobar_choque_losa(self.jugador.rect_personaje,mesa.pedido.rect_objeto_izquierda) and mesa.pedido.pedido_preparado:
            ...
            for mesa in lista_mesas:
                if mesa.cliente != None:
                    if not mesa.pedido_tomado and mesa.colision:
                        ...
                        lista_pedidos.append(mesa.pedido)
                        mesa.pedido.determinar_posicion_comida("barra",self.pantalla,lista_pedidos)
                    ...
                    if mesa.pedido_tomado and not mesa.finalizada:
                        ...
                        if mesa.colision and mesa.pedido.colision:
                            ...
                            lista_pedidos.remove(mesa.pedido)
                        #Actualizamos tiempo
