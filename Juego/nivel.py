...
#Ajustando burbuja dialogo
#Si tocas a un cliente reinicias paciencia aunque no tengas comida

class Nivel:
    def __init__ (self,duracion_nivel:int,objetivo_dinero:int,lista_mesas:list,rutas_comidas_adicionales:list,rutas_clientes_adicionales:list):
        pygame.init()
        ...
        #self.lista_imagenes_comidas = cargar_imagenes_comidas_disponibles(rutas_comidas_adicionales)
    ...
    def correr_nivel(self):
        ...
        while self.corriendo:
            ...
            for mesa in lista_mesas:
                ...
                if not mesa.ocupada:
                    imagen_cliente = (random.choice(self.lista_clientes_disponibles))
                    mesa.llenar_mesa(self.tiempo_total_juego,Cliente(imagen_cliente,self.diccionario_imagenes["cliente_enojado"],mesa.rect_objeto))
                ...
                if mesa.cliente != None:
                    ...
                    if mesa.pedido_tomado and not mesa.finalizada:
                        ...
                        if mesa.pedido.comida_siendo_llevada:
                            print(len(self.jugador.tipos_pedidos_llevados))
            ...
            if (self.tiempo_total_juego) > self.duracion_nivel:
                print(f"Dinero conseguido: {self.dinero_ahorrado}\nDinero necesario: {self.objetivo_dinero}")
