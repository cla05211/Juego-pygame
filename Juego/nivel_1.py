...
class Juego:
    def __init__ (self):
        ...
        self.lista_mesas = cargar_lista_mesas([[2,1],[6,1]],self.diccionario_imagenes)
        #,[2,4],[6,4],[2,7],[6,7]]
                ...
                if not mantiene_presionado:
                    ...
                    #Interacciones (tecla Z)        
                        ...
                        for mesa in lista_mesas:
                            ...
                            if mesa.colision and mesa.ocupada:
